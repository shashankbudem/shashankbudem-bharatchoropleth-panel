...
// Vendored in this repository rather than read from the monorepo, so the plugin
// builds standalone and the boundaries that ship are the ones in the tree.
// `npm run sync:geometry` refreshes them from the source repository.
